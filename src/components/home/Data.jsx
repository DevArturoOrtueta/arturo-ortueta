        ...
        <div className="home__data">
            <h1 className="home__title">
                ...
                <svg
                    ...
                    className="home__hand bx-tada-hover"
                >
                    <path
            ...
            <p className="home__description">I'm creative developer based in Panama, and I'm very passionate and dedicated to my work.</p>

            <a href="mailto:dev.arturo.ortueta@gmail.com" className="button button--flex">
                Say Hello
                <svg
